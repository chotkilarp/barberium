...
export const BRANCHES: Branch[] = [
  {
    ...
    metro: "рядом с метро «Дружба народов» («Халқлар Дўстлиги»)",
    hours: "10:00–22:00, ежедневно",
    mapsLink: "https://www.google.com/maps?q=Islam+Karimov+street+8+Tashkent+Barberium",
    mapsEmbed: "https://www.google.com/maps?q=Islam%20Karimov%20street%208%20Tashkent%20Barberium&output=embed",
  },
  {
    name: "Филиал №2",
    address: "пр. Бунёдкор, 4, Ташкент",
    hours: "10:00–22:00, ежедневно",
    mapsLink: "https://maps.app.goo.gl/SRUrbzFaZTt43Zu89?g_st=ac",
    mapsEmbed: "https://www.google.com/maps?q=Barbershop%20Barberium%20Bunyodkor%204%20Tashkent&output=embed",
  },
];
