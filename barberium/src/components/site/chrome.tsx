...
import { Monogram, BookButton } from "./ui";
    ...
    <footer id="contacts" className="relative overflow-hidden border-t border-border">
      ...
      <div className="relative mx-auto max-w-6xl px-5 py-16">
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-2">
          {BRANCHES.map((b) => (
            <div key={b.name} className="glass overflow-hidden">
              <div className="p-6 pb-0 sm:p-8 sm:pb-0">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="mt-2 inline-block font-display text-[11px] uppercase tracking-[0.22em] text-gold hover:underline"
                >
